...
function AboutPage(){
    return(
        <AboutPageStyle className='about-page' data-aos='fade-left'>
            <Heading title='About' title1='Me'/>
            <div className='personal-infos'>
                <div className='head'>PERSONAL INFOS:</div>
                <div className='body'>
                    <div className='media-img'>
                        {/* <LazyLoadImage className='img' src='assets\img\homepage.jpg' width='100%' height='100%' effect='blur'/> */}
                ...
                <Link to='/contact'><Button text='HIRE ME'/></Link>
